...
This is a MCPServer exposing a tool which calls the supporting RESTApp developed for the cookbook example: recipe-002-custom-mcp-tool-assistant-integration
