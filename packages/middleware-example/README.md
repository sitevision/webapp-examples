...
An example on how yo utilize middleware for permission checks and collecting common data needed for routes. This can help you avoid code duplication or accidentally miss an important permission check.
